...
export const CardCoupons = ({data}: Props) => {
    moment.locale('es');
    return (
        <div className="pb-4">
            <Link href={'/coupons-udemy/[ruta]'} as={`/coupons-udemy/${data.ruta}`} className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">

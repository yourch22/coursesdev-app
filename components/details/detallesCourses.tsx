...
export const detallesCourses = ({item}) => {
    // moment.locale('es');
    return (
                    ...
                    <article className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
                        ...
                        <div data-aos="fade-left" data-aos-delay="200">
                            ...
                            <footer className="mt-2 flex flex-wrap items-center justify-between">
                                <div className="flex items-center space-x-2">
                                <Link href="#">
                                    <Image className="rounded-full shrink-0 mr-4" src="#" width="40" height="40" alt="Author 04" />
                                </Link>
                    ...
                    <div className=" max-w-5xl px-10 py-2 bg-white rounded-lg shadow-md">
                        <div className="mx-auto flex flex-wrap">
                            ...
                            <div className="mt-2">
                                ...
                                <p className="mt-2 text-gray-600" dangerouslySetInnerHTML={{ __html: item.descripcion }}>
                                </p>
                            </div>
                    ...
                    <div className="flex flex-col bg-white max-w-lg px-6 py-4 mx-auto rounded-lg shadow-md">
                        {/* {
                            outstanding.map((items)=>(
                                <Link href={'/coupons-udemy/[ruta]'} as={`/coupons-udemy/${items.ruta}`}>

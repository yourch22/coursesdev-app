...
const PageCoursesCoupons = (coursesdiscount) => {
    const router = useRouter();
    // const page: any = router.query.page;
    const routePaginate = "/courses?page=";
    // const totalCourses = coursesdiscount.coursesCountDataDiscont.count;
    const totalCourses = coursesdiscount.coursesCountDataDiscont[0].count;
                ...
                <div className="h-full ml-14 mt-14 mb-10 md:ml-64">
                    <div className="w-full mt-8 mb-6 mx-auto px-4 flex items-center justify-between">
                        <h1><span className="text-2xl">
                            ...
                            <strong className="text-2xl"> Desarrollo Frontend y Backend</strong>
                        </span>
                        </h1>
                    </div>
...
export default PageCoursesCoupons